...
list(
  ...
  tar_target(catch_basins_pmtiles_path,
             ...
             format = "file"),
  tar_target(gi_flood_pmtiles_path,
             write_gi_flood_pmtiles(gi_all_assets, "data/processed/gi_flood.pmtiles"),
             format = "file"),
  tar_target(gi_all_pmtiles_path,
             write_gi_all_pmtiles(gi_all_assets, "data/processed/gi_all.pmtiles"),
             format = "file"),
